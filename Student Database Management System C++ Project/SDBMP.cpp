...
int main()
{
    ...
    while(1)
    {
        ...
        cout<<"Ghougle Anas Mohammed Naeem"<<endl;
        cout<<"Shaik Mhod Asil Aqueel"<<endl;
        cout<<"khan Umair Aslam"<<endl;
        cout<<"Quadri Omair Mhommed Rishad "<<endl;
        cout<<"Rizvi Ahemd Abbas Nasir Hussain"<<endl;
        cout <<"\n\n                                          ";
        cout << "\n \t\t\t 1. Add    Records";
        cout << "\n \t\t\t 2. List   Records";
        cout << "\n \t\t\t 3. Modify Records";
